...
//     console.log("itemId feom SearchItemUpdate",itemId)
...
// export default SearchItemUpdate;
...
const SearchItemUpdate = () => {
    console.log("SearchItemUpdate")
  return (
    <View>
      <Text>SearchItemUpdate</Text>
    </View>
  )
}
