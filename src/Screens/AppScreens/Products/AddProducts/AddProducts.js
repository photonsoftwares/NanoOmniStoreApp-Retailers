...
// import React, { useState, useCallback } from 'react';
// import { StyleSheet, View, TextInput, Alert, Text, ScrollView, Image, TouchableOpacity } from 'react-native';
// import HeaderComp from '../../../../Components/HeaderCompo';
// import ButtonCompo from '../../../../Components/ButtonCompo';
// import DropDownPicker from 'react-native-dropdown-picker';
// import { moderateScale } from '../../../../styles/responsiveSize';
...
//                     <View style={{ height: moderateScale(150), width: moderateScale(150), justifyContent: 'center', borderRadius: 8, elevation: 8, backgroundColor: "#fff" }}>
//                         <View style={{ height: '100%', width: '100%', }}>

//                             <MaterialCommunityIcons name="account" size={155} color={'#ECE447'} />
//                         </View>
//                         <TouchableOpacity style={{ height: '25%', width: '25%', alignSelf: 'flex-end', }} activeOpacity={0.8}>
//                             <Image
...
//                     </View>
//                     <Text style={{ marginTop: moderateScale(8) }}>Please Upload Item Image</Text>
//                 </View>
