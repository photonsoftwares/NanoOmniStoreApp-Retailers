...
// import { CategoryItemUpdateMethod, GetCategoryItemMethod, GetCategoryMethod, GetSearchItemsMethod, GetSelectedCategoryItemsMethod, ItemUpdateMethod, RecommendedItemMethod, uploadImageMethod } from '../../../../../config/userApiMethods';
...
//     useEffect(() => {
//         setSelectedCategory(itemToUpdate.category)
//     })
...
const UpdateCategoryItems = ({ route }) => {
    ...
    return (
        <>
            ...
            {/* <View style={{ marginHorizontal: 16, gap: 48, marginBottom: 8, backgroundColor: '#fff' }}>
                {categoryData.length > 0 ?
                    // <View style={{ marginTop: 8, paddingVertical: 8 }}>
                    <View style={{}}>
                        <Text style={[styles.label, { marginBottom: 8 }]}>Category</Text>
