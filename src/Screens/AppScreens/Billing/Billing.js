...
//         <Text style={[styles.itemPrice, { textDecorationLine: 'line-through' }]} numberOfLines={1}>{item.actual_price > item.price ? '₹' : ''}{item.actual_price > item.price ? item.actual_price : ''}</Text>
