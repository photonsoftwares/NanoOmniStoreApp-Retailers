...
// import { GetCustomerAddressMethod, OrderMasterDetailsMethod, SaveTransactionMethod, UpdateOrderMasterMethod, UpdateOrderStatusMethod } from '../../../../../config/userApiMethods';
...
//   // console.log("order_id, order_date, orderMobileNumber", customerBookedOrders)
...
//     const pdf_file_name = await dispatch(SaveTransactionMethod(saveTBody, order_id))
...
//         {/* <Button title='hjkl' onPress={()=>dispatch(UpdateOrderStatusMethod("12345"))}/> */}
...
import { useDispatch, useSelector } from 'react-redux';
import { OrderMasterDetailsMethod, SaveTransactionMethod, UpdateOrderMasterMethod, UpdateOrderStatusMethod } from '../../../../../config/userApiMethods';
import ButtonCompo from '../../../../../Components/ButtonCompo';
import HeaderComp from '../../../../../Components/HeaderCompo';
import { useNavigation } from '@react-navigation/native';
import Loader from '../../../../../Components/Loader';
